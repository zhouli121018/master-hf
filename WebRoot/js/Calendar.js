...
+' style="' + s_tiannet_day + '"> </td>');  
document.write('<td align="right" colspan="5"><input type="button"  onclick="tiannetClear();" style="' + s_tiannet_link + '" value="清空"/>'+  
' <input type="button"  onclick="tiannetHideControl();" style="' + s_tiannet_link + '" value="关闭"/>' +  
' <input type="button"  onclick="tiannetSetValue(true)" style="' + s_tiannet_link + '" value="确定" /> ' +  
'</td>');  
document.write (' </tr>');  
document.write('</table>');  
document.write('</div>');  
