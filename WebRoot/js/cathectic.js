 ...
 */
function getDetail(pageIndex,type,path,startTime,endTime,inviteCode,uuid){
	
		$.ajax({	
			   type: "POST",
			   url: path+"controller/manager/getPaylogLots?pageNum="+pageIndex+"&type="+type+"&startTime="+startTime+"&endTime="+endTime+"&inviteCode="+inviteCode+"&uuid="+uuid,
			   data: "",
			        ...
			        if(totalPages>1){
			        	var options = {
			                    ...
			                    onPageChanged: function(e,oldPage,newPage){
			                    	getDetail(newPage,type,path,startTime,endTime,inviteCode,uuid);
			                    }
			                }
