...
//	private static String appsecret = " ";// 应用密钥
	private static String partner = "1312053701";// 微信支付商户号
	private static String partnerkey = "e2fc714c4727ee9395f324cd2e7f331f";// 财付通初始密匙?
	...
	public static String createSign(Map<String, Object> map) {
		...
		while (it.hasNext()) {
			...
			if (!StringUtil.isEmpty(v) && !"sign".equals(k) && !"key".equals(k)) {
				sb.append(k + "=" + v + "&");
			}
		}
	...
	//云服务其上的根目录地址  /usr/local/tomcat/webapps/Technology_DDL/images/
	final static String KEYSTORE_PASSWORD = "1312053701";
